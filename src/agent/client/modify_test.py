...
test_res3  = {
    ...
    "test":[{"class":"ModifyTest", "function":["test_insertKV", "test_insertElements"]}]
}
...
class ModifyTest(unittest.TestCase):
    ...
    def test_insertKV(self):
        deepTrees = ["instruction"]
        res = modify.insert_kv(deepTrees, test_data,"moudle","modify")
    ...
    def test_delete_key(self):
        deepTrees = ["instruction"]
        res = modify.delete_key(deepTrees, test_res1,"moudle")
    ...
    def test_Unit(self):
        ...
        deep_trees = ["test", "0"]
        res = modify.insert_kv(deep_trees, test_data_, "function", ["test_insertKV"])
