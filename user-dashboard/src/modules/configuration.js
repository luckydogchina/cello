...
module.exports = {
    ...
    SV_BaseURL: process.env.SV_BaseURL || "http://localhost:8081/api/",
    RESTful_Server: process.env.RESTful_Server || "localhost:8081",
    ...
    PoolManager_BaseURL: "/v2/",
    Log_Server: process.env.Log_Server || "localhost:8081",
    Log_BaseURL: "/v1/log",
